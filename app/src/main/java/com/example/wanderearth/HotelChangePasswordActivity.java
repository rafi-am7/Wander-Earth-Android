...
public class HotelChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_change_password);
                            ...
                            mAuth.getCurrentUser().updatePassword(newp).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        errorMessage.setTextColor(ContextCompat.getColor(HotelChangePasswordActivity.this, R.color.success));
                                        errorMessage.setText("Password has changed successfully!");
                                        errorMessage.setVisibility(View.VISIBLE);

                                    } else {
                                        errorMessage.setTextColor(ContextCompat.getColor(HotelChangePasswordActivity.this, R.color.error));
